...
## Set up
Install the Pypi package (current version is 0.0.34):
```python
pip3 install infercode
```
<p align="center"> <object data="demo.svg" width="80%"></object> <p>    
## Usage
...
If there are exactly two code files, the tool prints the cosine similarity between them.
